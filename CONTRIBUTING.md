# Contributing to `cross-spawn-windows-exe`

`cross-spawn-windows-exe` is a community-driven project. As such, we welcome and encourage all
...
We use the label [`help wanted`](https://github.com/malept/cross-spawn-windows-exe/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) in the issue tracker to denote fairly-well-scoped-out bugs or feature requests that the community can pick up and work on. If any of those labeled issues do not have enough information, please feel free to ask constructive questions. (This applies to any open issue.)
...
```
commit 1: feat: add foo option
commit 2: feat: add bar option
```
